...
function numOfProvinces(isConnected) {
    ...
    // console.log('provinceCount: ', provinceCount);
    return provinceCount;
}

console.log('numOfProvinces([[1,1,0],[1,1,0],[0,0,1]]): ', numOfProvinces([[1,1,0],[1,1,0],[0,0,1]]));
console.log('numOfProvinces([[1,0,0],[0,1,0],[0,0,1]]): ', numOfProvinces([[1,0,0],[0,1,0],[0,0,1]]));